  ...
  return (
    <div className='flex flex-col mx-auto py-5'>
      <div className="relative px-4 sm:px-4 lg:px-8">
          <nav className='max-w-2xl flex mx-auto items-center justify-evenly'>

            <a href='/' className='text-lg flex font-semibold text-slate-100'>
            <span>Nickolas Tazes</span>
            </a>
            <div className='text-base flex  text-slate-100'>
            <a href="/blog" className='hover:text-orange-500 mr-4'>Blog</a>
