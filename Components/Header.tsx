    ...
    <div className='py-5 sticky top-0 z-10 navbar'>
            ...
            <div className="mx-auto max-w-2xl px-4 md:px-0.5 lg:px-0.5">
              <nav className="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
                <div className="flex flex-1 items-center md:absolute md:inset-y-0 md:left-0">
                  <div className="flex w-full items-center justify-between md:w-auto">
                    ...
                    <div className="-mr-2 flex items-center md:hidden">
                      <Popover.Button className="inline-flex items-center justify-center rounded-md p-2 text-gray-300 hover:text-orange-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-orange-500">
                ...
                <div className="hidden md:flex md:space-x-10 md:absolute md:inset-y-0 md:right-0 md:items-center md:justify-end">
                  {navigation.map((item) => (
