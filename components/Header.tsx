            ...
            <div className="mx-auto max-w-2xl relative px-4 lg:px-8">
              <nav className="relative flex items-center justify-between sm:h-10 md:justify-end" aria-label="Global">
                <div className="flex flex-1 items-center md:absolute md:inset-y-0 md:left-0">
                  <div className="flex w-full items-center justify-between md:w-auto">
                    <a href="/">
                        ...
                        <p className='text-xl text-slate-100 font-semibold'>Nickolas Tazes</p>
                    </a>
                    <div className="-mr-2 flex items-center md:hidden">
                      <Popover.Button className="inline-flex items-center justify-center rounded-md p-2 text-gray-300 hover:text-orange-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-orange-500">
                ...
                <div className="hidden md:flex md:space-x-5">
                  {navigation.map((item) => (
                    <a key={item.name} href={item.href} className="font-medium text-orange-500 hover:text-orange-700">
                      {item.name}
                    </a>
                  ))}
                </div>
